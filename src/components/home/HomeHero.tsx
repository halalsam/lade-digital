    ...
    <section className="relative px-6 pb-28 pt-48 md:px-12 md:pt-52 lg:px-60">
      <div className="mx-auto w-full max-w-400">
        <RevealText
          ...
          className="display-xl text-black leading-tight mx-auto block max-w-5xl text-center"
          delay={0.05}
          stagger={0.07}
        />
        <RevealText
          ...
          className="mx-auto mt-12  block max-w-210 text-center text-2xl leading-tight tracking-[0.02em]"
          delay={0.3}
          stagger={0.025}
        />
      </div>
