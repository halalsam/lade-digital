...
<Figure src="/assets/blog/home.png" alt="the recede-and-rise transition between two pages" caption="The full transition: the current page recedes into the dark as the incoming sheet rises over it." />
...
<Figure src="/assets/blog/projects.png" alt="diagram of the old page receding and the new page rising" caption="Two keyframes: page-recede scales the old snapshot back and dims it; page-rise slides the new snapshot up over it." />
